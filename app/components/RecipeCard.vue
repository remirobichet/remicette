...
const recipeData = props.recipe.meta

const currentServings = ref(recipeData.servings || 4)
  ...
  <div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 p-6 bg-gray-50 rounded-lg mb-8">
      ...
      <div class="flex flex-col gap-1">
        ...
        <span class="text-lg font-semibold text-gray-900">{{ recipeData.prepTime }} min</span>
      </div>
      <div class="flex flex-col gap-1">
        <span class="text-xs uppercase tracking-wide text-gray-600">Cuisson</span>
        <span class="text-lg font-semibold text-gray-900">{{ recipeData.cookTime }} min</span>
      </div>
      <div class="flex flex-col gap-1">
        <span class="text-xs uppercase tracking-wide text-gray-600">Total</span>
        <span class="text-lg font-semibold text-gray-900">{{ recipeData.totalTime }} min</span>
      </div>
    </div>
